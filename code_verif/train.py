...
if __name__ == '__main__':
    ...
    parser.add_argument('--name',default='ft_ResNet50_detail', type=str, help='output model name')
    # data '../represent'
    parser.add_argument('--data_dir',default='../detail',type=str, help='training dir path')
